...
def main():
    ...
    boton1a=pygame.image.load("SALIr.png")
    boton1b=pygame.image.load("SALIR2.png")
    boton2a=pygame.image.load("CREDITOS.png")
    boton2b=pygame.image.load("CREDITOS2.png")
    boton3a=pygame.image.load("jugar.png")
    boton3b=pygame.image.load("jugar2.png")
    boton4a=pygame.image.load("TITULO.png")
    boton4b=pygame.image.load("TITULO2.png")
    ...
    sonido1=pygame.mixer.Sound("FIN.wav")
    sonido2=pygame.mixer.Sound("USADO.wav")
